...
export default async function LocalizedHome({ params }) {
  ...
  const texts = {
    ...
    zh: {
      title: "PaceGuru",
      heroTagline: "把每一跑，\n跑得更明白。",
      heroSubtitle: "PaceGuru 帮你把 Apple Watch 里的跑步数据，变成下一次训练该怎么跑的答案。",
      heroBadge: "Apple Watch · iPhone",
      ...
      statsRatingValue: "4.8 ★",
      statsDownloadsValue: "10K+",
      statsDownloads: "正在使用的跑者",
      statsPlansValue: "5+",
      statsPlans: "训练计划",
      showcaseTitle: "跑得更久，也跑得更懂",
      showcase: [
        {
          tag: "配速 × 心率",
          title: "快慢怎么变，\n心率一眼看懂",
        ...
        },
        {
          tag: "训练计划",
          title: "训练计划，\n抬腕就能开跑",
          desc: "Hansons、Daniels' 经典计划，18 周训练安排同步到 Apple Watch，照着做就行。",
        },
      ],
      keyFeatures: "全部功能",
      keyFeaturesSubtitle: "跑得更好，真正用得上的工具",
      testimonialsTitle: "跑者真实评价",
      testimonials: [
        {
          name: "Sarah K.",
          tag: "马拉松跑者 · 3:42 个人最好",
          text: "同步很顺，计划也好跟。PaceGuru 让我终于能把训练坚持下来。",
        },
        {
          name: "Marcus L.",
          tag: "半程马拉松 · 1:48 个人最好",
          text: "试过不少跑步 App，PaceGuru 的数据不只好看，还能告诉我下一步怎么练。",
        },
        {
          name: "Yuki T.",
          tag: "5K 跑者 · 22:30 个人最好",
          text: "每次跑完看看 AI 分析，就知道今天练到了什么、下次该注意什么。",
        },
      ],
      getStarted: "下一次跑步，跑得更有数",
      getStartedSubtitle: "用 PaceGuru，把训练安排得更清楚一点。",
      contact: "联系我们：",
      termsOfService: "服务条款",
      privacyPolicy: "隐私政策",
      blog: "博客",
      about: "关于",
      features: {
        sync: { title: "Apple Watch 同步", description: "跑完汇总 Apple Watch 数据，打开就能看。" },
        tracking: { title: "跑步追踪", description: "把周、月训练量、配速和趋势放在一起，进步看得见。" },
        insights: { title: "跑步数据", description: "距离、配速、心率和热量放在一张图里，不必来回找数据。" },
        training: { title: "训练计划", description: "按自己的配速和心率区间安排训练，并同步到 Apple Watch。" },
        plan: { title: "计划、开跑、复盘", description: "给下一次训练定个目标；跑完回看，再慢慢跑出改变。" },
        analytics: { title: "训练分析", description: "不管目标是跑完第一个 5K，还是刷新马拉松 PB，都能找到训练方向。" },
        tools: { title: "跑步工具", description: "配速、VDOT 等常用计算工具，跑前跑后随手查。" },
        shoes: { title: "跑鞋记录", description: "每双鞋跑了多少、用了多久，心里有数。" },
        ai: { title: "AI 跑后反馈", description: "跑后给你一份有重点的反馈，不只报数据。" },
      }
    },
    ja: {
      title: "PaceGuru",
