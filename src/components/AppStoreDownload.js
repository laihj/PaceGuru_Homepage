  ...
  return (
    <div className={`flex flex-col sm:flex-row gap-4 justify-center items-center ${className}`}>
      <a
        ...
        className="inline-flex items-center gap-3 bg-white text-black font-bold rounded-2xl px-8 py-4 text-base hover:bg-gray-200 transition-all shadow-lg hover:shadow-xl active:scale-95"
      >
